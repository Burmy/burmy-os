  ...
  return (
    <div className="mt-4 space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <MonthNavigator year={year} month={month} years={years} />
      ...
      {view === 'month' ? (
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-5">
            <StatCard label="YTD Income" value={format(cents(ytd.summary.incomeCents), { signed: true })} />
            <StatCard label="YTD Expenses" value={format(cents(ytd.summary.expenseCents))} />
            <StatCard
              label="YTD Net"
          ...
          <ChartCard title={`${ytd.summary.year} income vs expenses`} subtitle="Every month so far this year">
